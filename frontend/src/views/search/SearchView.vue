<template>
  <div>
    <!-- thanh tìm kiếm -->
    <div>
      <div class="mx-auto md:w-[750px] w-5/6 rounded-2xl flex text-xl">
        <div class="basis-3/4">
          <input
            v-model="keySearch"
        ...
        <div class="w-[200px] basis-1/4 m-2">
          <div
            class="hover:scale-125 duration-300 cursor-pointer mx-auto w-[150px] active:bg-violet-500/50 text-center hover:bg-violet-500/20 truncate shadow-violet-500 shadow-md p-3 rounded-2xl hover:text-violet-800"
          >
    ...
    <!-- kiểu tìm kiếm -->
    <div class="mx-auto md:w-[750px] w-5/6 rounded-2xl mt-5 text-2xl">
